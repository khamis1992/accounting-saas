...
export function Sidebar() {
  ...
  const implementedPages = [
    ...
    `/${locale}/accounting/general-ledger`,
    `/${locale}/accounting/trial-balance`,
    `/${locale}/accounting/financial-statements`,
    `/${locale}/sales/customers`,
    `/${locale}/sales/invoices`,
    `/${locale}/sales/quotations`,
    `/${locale}/sales/payments`,
    `/${locale}/purchases/vendors`,
    `/${locale}/purchases/expenses`,
    `/${locale}/banking/accounts`,
    `/${locale}/banking/reconciliation`,
    `/${locale}/tax/vat`,
    `/${locale}/tax/vat-returns`,
    `/${locale}/reports`,
    `/${locale}/settings/company`,
    `/${locale}/settings/users`,
    `/${locale}/settings/roles`,
    `/${locale}/settings/fiscal`,
    `/${locale}/settings/cost-centers`,
  ];
    ...
    },
    {
      ...
      items: [
        ...
        { title: t("trialBalance"), href: `/${locale}/accounting/trial-balance`, icon: null },
        {
          ...
          href: `/${locale}/accounting/financial-statements`,
          icon: null,
        },
      ],
    },
