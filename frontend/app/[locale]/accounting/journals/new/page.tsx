...
import { journalsApi, CreateJournalDto, JournalLine } from '@/lib/api/journals';
...
export default function NewJournalPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.push(`/en/accounting/journals/${result.id}`);
    } catch (error: any) {
  ...
  const getAccountName = (accountId: string) => {
    ...
    return account ? `${account.code} - ${account.name_en}` : '';
  };
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={(value) =>
                      setFormData({ ...formData, journalType: value as any })
                    }
                    required
                  >
